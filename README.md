# DAA-Assignment-1
# Maximal Clique Enumeration Algorithm given in the paper (ARBORICITY AND SUBGRAPH LISTING ALGORITHMS*) by NORISHIGE CHIBA AND TAKAO NISHIZEKI
